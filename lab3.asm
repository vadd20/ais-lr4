...
; Задача 0
Task_0:
;3 call priveleged command in ring 0
;lea	bp, [es:0]
;sidt	[bp]
;lidt	[bp]
...
;3 call privileged command lidt in ring 3 throws exception
;lea    bp, [fs:0]
;sidt 	[bp]
;lidt	[bp]

;2 try to access to selector of GDT_32bitDS with DPL = 0 (6th byte; 2,3 bits)
; general protection fault exception
;mov     ax, SEL_32bitDS
;mov     ds, ax
;mov     al, [ds:0]

;2 far transition using data segment selector
;mov     ax, SEL_32bitDS
;push    ax		; ds selector to stack (cs)
;push    offset Task_2	; offset task_2 to stack (ip)
;retf			; take from stack cs:ip (wtired above)
